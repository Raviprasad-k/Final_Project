...
public class TestListener implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		// 3. Create a unique filename for Eclipse
		String reportPath = "artifacts/ExtentReport_" + timestamp + ".html";
	...
	public void onTestStart(ITestResult result) {
		...
		extentTest.assignAuthor("QEA_Team_3");
		extentTest.assignCategory("Test_Suite");
		test.set(extentTest);
	}
